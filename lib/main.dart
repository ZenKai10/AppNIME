...
class _LoadingScreenState extends State<LoadingScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.black, body: SizedBox());
  }
}
                  ...
                  children: [
                    ...
                    SlideTransition(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Mari kita mulai dengan aplikasi luar biasa saya dan tonton anime favorit Anda',
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  AnimeScreen(), // Arahkan ke HomeScreen
                            ),
                          );
                        },
